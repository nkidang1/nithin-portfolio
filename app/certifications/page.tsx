    ...
    <main className="min-h-screen bg-black text-white py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-xl text-gray-300 leading-8 mb-14">
          ...
          SystemVerilog, UVM, Assertion-Based Verification, RTL Design,
          FPGA Development, and VLSI System Design.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="border border-gray-800 rounded-2xl p-6">
            ...
            <p className="text-gray-300 leading-7 mb-4">
              Completed Cadence training covering SystemVerilog language
              fundamentals, RTL modeling, object-oriented programming,
              interfaces, assertions, constrained random verification,
              and modern hardware verification methodologies.
            </p>
          ...
          <div className="border border-gray-800 rounded-2xl p-6">
            ...
            <p className="text-gray-300 leading-7 mb-4">
              Completed Cadence SystemVerilog Assertions v5.2 training
              focused on assertion-based verification, temporal properties,
              protocol checking, sequence operators, and advanced
          ...
          <div className="border border-gray-800 rounded-2xl p-6">
            ...
            <p className="text-gray-300 leading-7 mb-4">
              ...
              simulation, synthesis concepts, and synthesizable hardware
              modeling practices.
            </p>
          ...
          <div className="border border-gray-800 rounded-2xl p-6">
            ...
            <p className="text-gray-300 leading-7 mb-4">
              Coursework covering VLSI SoC architecture, subsystem
              integration, RTL development, interconnect concepts,
              memory hierarchy, and digital hardware development
              methodologies.
            </p>
          ...
          <div className="border border-gray-800 rounded-2xl p-6">
            ...
            <p className="text-gray-300 leading-7 mb-4">
              Training in industry-oriented VLSI development methodology
              including RTL design flow, verification concepts,
              synthesis awareness, timing-driven design practices,
              and ASIC/FPGA development processes.
            </p>
          ...
          <div className="border border-gray-800 rounded-2xl p-6">
            ...
            <img
              src="/images/certifications/EssentialSV.png"
              alt="Cadence Essential SystemVerilog for UVM"
              className="w-full h-[320px] object-contain rounded-xl bg-white p-4"
            />
            ...
            <p className="text-gray-300 leading-7 mb-4">
              ...
              verification, virtual interfaces, sequencers, drivers, monitors, scoreboards,
              and reusable verification methodologies for ASIC and FPGA verification.
            </p>

            <p className="text-gray-500">
              UVM • Constrained-Random Verification • Object-Oriented Programming • SystemVerilog
            </p>
